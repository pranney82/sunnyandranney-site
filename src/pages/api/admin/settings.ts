...
const VALID_KEYS = ['settings:hours', 'settings:collections', 'settings:specials', 'settings:contact', 'settings:email-signup', 'settings:trending', 'settings:hero', 'settings:kids', 'settings:team'];
