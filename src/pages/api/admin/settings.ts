...
const VALID_KEYS = ['settings:hours', 'settings:collections', 'settings:specials', 'settings:contact', 'settings:email-signup', 'settings:hero', 'settings:kids', 'settings:team', 'settings:staff-picks'];
